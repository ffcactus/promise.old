...
public class LoginFailException extends PromiseException {
	...
	public LoginFailException(Exception e) {
		...
		String[] reason = {"The username or password is incorrect.", "The user is not exist."};
		String[] solution = {"Make sure the username and password is correct", "Create the user."};
